...
public class MethodTest {
    ...
    public void test05() {
        ...
        Consumer<String> fun = person::study;
        fun.accept("WebFlux");  // 相当于person.study("WebFlux")
    }

    // Lambda无参构造器引用   类名::new
    @Test
    public void test06() {
        // 无参构造器没有输入,但有输出,符合函数式接口Supplier的定义
    ...
    @Test
    public void test07() {
        // 带参构造器仅有一个输入,且有输出,符合函数式接口Function的定义
        Function<String, Person> fun = Person::new;
        System.out.println(fun.apply("王五"));  // 相当于 new Person("王五")
    }
